...
(function($) {
                            ...
                            baseItem.on('click', function() {
                                ...
                                if (item.prop('checked')) {
                                    ...
                                    $.ajax({
                                        ...
                                        var tableItem = tables.find('.item-table > input');
    ...
    $.fn.thematicSelectHandler = function(options) {
        ...
        $.ajax({
            ...
            var container = options.self.elements.dataTables.find('.form-checkboxes');
            ...
            if (typeof data === 'object') {
                $.each(data, function(source, bases) {
                    ...
                    if (typeof bases === 'object') {
                        ...
                        basesContainer.appendTo(container);
                    }
                });
            } else {
